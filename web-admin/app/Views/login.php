            ...
            <form>
                    <div class="form">
                        <div class="form-group col-lg-6 mx-auto pt-5">
                            <img src="brand.png" alt="logo brand">
                        </div>
                        <div class="form-group col-lg-4 mx-auto">
                            <label for="exampleInputEmail1" style="font-family: Gotham Rounded;"> Alamat Email atau Username</label>
